                    ...
                    <h2><a href="#">${boardnew.title}</a></h2>
                     <div class="aa-article-bottom">
                      <div class="aa-post-author">
                        Posted by <a href="#">${boardnew.author}</a>
                      </div>
                ...
                <aside class="aa-blog-sidebar">
                  ...
                  <div class="aa-sidebar-widget">
                   ...
                   <c:forEach items="${boardnewlist}" var="boardnew" end="2">
                        <li>
                          <a class="aa-cartbox-img" href="${pageContext.request.contextPath}/view/client/news-list-detail?id=${boardnew.id}"><img src="${boardnew.image_link}" alt="img bài viết"></a>
