            ...
            <div class="aa-product-catg-body">
              ...
              <ul class="aa-product-catg">
                ...
                <c:if test="${empty productlist}">
                 	<p style="margin-left: 30px">Not found!</p>
                 </c:if>
                ...
                <c:forEach items="${productlist}" var="product">
	                ...
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img src="${product.image_link}" alt="${product.name}"></a>
              ...
              <c:forEach items="${catelist}" var="cate">
            	...
            	<!-- single sidebar -->
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-recently-views">
							<ul>
								<c:forEach items="${sanphambanchay}" var="product" end="0">
									<li><a
										href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"
										class="aa-cartbox-img"><img alt="img"
											src="${product.image_link}"></a>
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-recently-views">
							<ul>
								<c:forEach items="${sanphamgiamgia}" var="product" end="0">
									<li><a
										href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"
										class="aa-cartbox-img"><img alt="img"
											src="${product.image_link}"></a>
