...
<!--  content -->
  ...
  <section id="aa-catg-head-banner">
      <img src="${pageContext.request.contextPath}/view/client/assets/images/banner-makeup1.jpg" alt="banner sản phẩm">
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="${pageContext.request.contextPath}/view/client/product">Products</a></li>
              ...
              <div class="row">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="${detail_product.image_link}" class="simpleLens-lens-image"><img src="${detail_product.image_link}" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    <h3>Tên sản phẩm : ${detail_product.name }</h3>
                    <div class="aa-price-block">
                    <c:choose>
						<c:when test="${detail_product.discount == 0}">
	                      <span class="aa-product-price">Giá : 		${detail_product.price} VNĐ</span><span class="aa-product-price"></span>
	                    </c:when>
	                    <c:otherwise>
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                <c:forEach items="${productById}" var="product">
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img src="${product.image_link}" alt=""></a>
